        ...
        {config.overlayImage && (
          <div className={getCharacterPosition()}>
            ...
            >
              ...
              {/* Clean Character Display - No Gray Background Issues */}
              <div className="w-full h-full relative z-10">
                {/* Character rendered with proper background removal */}
                <img 
                  ...
                  style={{
                    ...
                    // Enhanced mix-blend-mode for better character integration
                    mixBlendMode: config.characterBlendMode === 'multiply' ? 'multiply' :
                                 config.characterBlendMode === 'screen' ? 'screen' :
